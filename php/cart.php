...
if (!isset($_COOKIE['email'])) {
    ...
    if (isset($_GET['button'])) {
        ...
        if ($op == "Pay") {
            ...
            $api_key = '92aca7c1-aa7a-487c-813e-6d91818c7ae5';
            $collection_id = 'wuwn56v9';
            ...
            $data = array(
                ...
                'callback_url' => "http://farhanizzuddin06.epizy.com/Mazkitchen",
                'redirect_url' => "http://farhanizzuddin06.epizy.com/Mazkitchen/php/payment_update.php?userid=$email&mobile=$mobile&amount=$amount"
            );
